...
const xsdString = new NamedNode(_index.xsd.string);
const rdfLangString = new NamedNode(_index.rdf.langString);
...
class Literal {
  constructor(value, language, datatype) {
    ...
    if (datatype.value === _index.xsd.string) {
      this.id = JSON.stringify(value);
    } else if (datatype.value === _index.rdf.langString && language !== "") {
...
function toId(term) {
  ...
  switch (term.termType) {
    ...
    case "Literal":
      return '"' + term.value + '"' + (term.language ? "@" + term.language : term.datatype && term.datatype.value !== _index.xsd.string ? "^^<" + term.datatype.value + ">" : "");
